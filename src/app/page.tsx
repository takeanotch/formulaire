...
export default function Home() {
  ...
  // Page principale avec le contenu pour les utilisateurs déjà soumis
  return (
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">
              Module Système d'exploitation - Ressources et téléchargements
            </p>
          </div>
        </div>
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">
              {alreadySubmitted ? 'Sondage déjà complété !' : 'Merci pour votre participation !'}
            </h2>
            <p className="text-gray-600 mb-2">
              {alreadySubmitted 
                ? 'Vous avez déjà participé à ce sondage. Une seule réponse est autorisée par personne.'
                : 'Votre réponse a été enregistrée avec succès.'
              }
            </p>
            <p className="text-sm text-gray-500">
              Voici les ressources disponibles pour le cours :
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Ressources en ligne</h3>
            <ImageLink
              src="/taptouche.png"
              alt="Tap Touche"
              href="https://app.taptouche.com/"
            ...
            <p className="text-sm text-gray-500 mt-2">
              Accédez à Tap'Touche pour améliorer votre vitesse de frappe
            </p>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-600">
                  Les travaux pratiques nécessitent un ordinateur portable avec Windows, macOS ou Linux
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} - Cours Bureautique - Tous droits réservés</p>
        </div>
      </motion.div>
    </main>
  )
